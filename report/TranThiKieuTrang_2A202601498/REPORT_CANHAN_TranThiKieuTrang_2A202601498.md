...
**Embedding Backend:** Gemini Text Embedding API (`models/gemini-embedding-001` - 3072 dims)
**LLM Backend:** Gemini 2.5 Flash API (Google AI)

| # | Câu hỏi (Query) | Top-1 Chunk truy xuất được (tóm tắt) | Điểm Score | Có liên quan không? (Relevant) | Câu trả lời của Gemini Agent (100% API) |
|---|-------|--------------------------------|-------|-----------|------------------------|
| 1 | Sản phẩm được mua tại GearVN sẽ được đổi mới trong vòng bao nhiêu ngày nếu phát sinh lỗi từ nhà sản xuất đối với các sản phẩm gaming gear? | Top-1 từ `gearvn-warranty-policy`: "Sản phẩm đổi mới trong 30 ngày đối với các sản phẩm lỗi phát sinh do nhà sản xuất..." | **0.9221** | Có — Tìm chính xác file và đoạn quy định bảo hành 30 ngày | "Sản phẩm gaming gear (Bàn phím, chuột, tai nghe…) được mua tại GearVN sẽ được đổi mới trong vòng 30 ngày tính từ ngày mua hàng nếu phát sinh lỗi do nhà sản xuất hoặc GearVN." |
| 2 | Thời gian tối đa để gửi chuyển trả sản phẩm lỗi cho GearVN là bao lâu? | Top-1 từ `gearvn-return-policy`: "Quý Khách hàng cần kiểm tra tình trạng hàng hóa và có thể đổi hàng/ trả lại hàng ngay tại thời điểm giao/nhận..." | **0.9045** | Có — Tìm đúng file chính sách đổi trả GearVN | "Context chỉ ra đổi/trả ngay tại thời điểm giao/nhận hàng nếu có lỗi ban đầu, đồng thời đề cập thời gian xử lý bảo hành là 30 ngày." |
| 3 | Khi thanh toán bằng ZaloPay trên website GearVN, tôi cần làm gì sau khi chọn hình thức thanh toán này? | Top-1 từ `gearvn-payment-guide`: "...hệ thống sẽ chuyển sang giao diện thanh toán ZaloPay. Bước 2: Mở ứng dụng ZaloPay quét mã QR..." | **0.9131** | Có — Tìm đúng file hướng dẫn thanh toán và bước quét mã QR | "Sau khi chọn hình thức thanh toán ZaloPay, hệ thống chuyển sang giao diện ZaloPay. Bạn mở ứng dụng ZaloPay và quét mã QR được cung cấp để hoàn tất đơn hàng." |
| 4 | Phí vận chuyển CellphoneS cho đơn hàng 250.000đ đối với người mua bình thường? *(Filter: `customer_role="buyer"`)* | Top-1 từ `cellphones-shipping-policy`: "e. Chi phí vận chuyển: ...Đối với các khách hàng còn lại: Đơn hàng dưới 300.000đ: Phí giao hàng 15.000đ" | **0.8901** | Có — Đã qua lọc `customer_role="buyer"` và tìm đúng bảng phí 15.000đ | "Phí vận chuyển của CellphoneS cho đơn hàng 250.000đ đối với người mua bình thường (không phải Smem/SVip) là 15.000đ." |
| 5 | Nếu tôi hủy đơn hàng CellphoneS và đã thanh toán qua thẻ ATM, tôi sẽ nhận lại tiền trong bao lâu? | Top-1 từ `cellphones-shipping-policy`: "...Thời gian hoàn tiền qua thẻ ATM: Trong vòng 7 - 10 ngày làm việc." | **0.8272** | Có — Tìm đúng mục thời gian hoàn tiền qua thẻ ATM | "Nếu bạn hủy đơn hàng CellphoneS và đã thanh toán qua thẻ ATM, bạn sẽ nhận lại tiền trong vòng 7 - 10 ngày làm việc." |
